...
│   │   ├── Sidebar/          # AI Provider selection panel
│   │   ├── Topbar/           # Mode selector component
│   │   ├── Section/          # Collapsible section component
│   │   └── ProviderItem/     # Provider checkbox component
│   └── imgly/
│       ├── index.ts          # CE.SDK initialization exports
│       ├── config/
│       │   ├── index.ts          # Mode initialization functions
│       │   ├── design-editor/    # Design mode configuration
│       │   ├── photo-editor/     # Photo mode configuration
│       │   └── video-editor/     # Video mode configuration
│       └── plugins/
│           └── ai-app/           # AI Apps plugin & providers
