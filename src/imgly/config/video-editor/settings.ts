...
export function setupSettings(engine: CreativeEngine): void {
  ...
  // Allow editing page titles by clicking on them (if supported)
  ...
  // Restrict color picker to RGB colors only (recommended for video)
  // - 'Any': Allow both RGB and CMYK (default)
  // - 'RGB': Restrict to RGB colors only
  // - 'CMYK': Restrict to CMYK colors only (for print)
  // engine.editor.setSetting('colorPicker/colorMode', 'RGB');
  // #endregion

  // ============================================================================
  // GRID SETTINGS
  // Configure grid display and snap-to-grid behavior
  // ============================================================================

  // #region Grid Settings
  // Enable background grid for precise alignment
  // engine.editor.setSetting('grid/enabled', true);

  // Enable snap-to-grid for precise positioning
  // engine.editor.setSetting('grid/snapEnabled', true);
  // #endregion
